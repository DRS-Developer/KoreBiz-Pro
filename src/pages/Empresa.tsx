    ...
    return (
      <div className="flex flex-col min-h-screen">
        <SEO 
          ...
          description="Conheça a ArsInstalações: nossa história, missão, visão e valores. Referência em qualidade e segurança em instalações elétricas."
            ...
            <div className="flex flex-col md:flex-row gap-12 items-center">
              <div className="md:w-1/2">
                ...
                <div className="prose text-gray-700">
                  <p className="mb-4">
                    Fundada em 2010, a ArsInstalações surgiu da necessidade de oferecer serviços técnicos especializados com um nível superior de qualidade e profissionalismo no mercado de São Paulo.
                  </p>
                  <p className="mb-4">
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-blue-900 mb-4">Por que escolher a ArsInstalações?</h2>
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <SEO 
        ...
        description={page.meta_description || 'Saiba mais sobre a ArsInstalações.'}
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
             <RichTextRenderer content={page.content} className="prose max-w-none text-gray-700 prose-headings:text-blue-900 prose-a:text-blue-600" />
          </div>
        </div>
      </section>
